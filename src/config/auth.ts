// tpass-appeals（consumer）SSO 設定中心。只讀 env，集中管理「對接 auth 所需的最少資訊」。
...
const self = process.env.APPEALS_SELF_URL!;
...
export const authConfig = {
  ...
  // 登出：夾帶 redirect_uri 回到自己首頁，登出後留在 T-Appeals 而不是被丟到 auth。
